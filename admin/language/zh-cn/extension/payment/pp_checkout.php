<?php
// Heading
$_['heading_title']					 = 'PayPal Checkout 标准支付方式';

// Text
$_['text_extension']   				 = '扩展功能';
$_['text_success']					 = 'Success: You have modified PayPal account details!';
$_['text_edit']                      = '编辑 PayPal 标准支付方式';
$_['text_pp_checkout']				 = '<img src="view/image/payment/paypal.png" alt="PayPal Website Payment Pro" title="PayPal Website Payment Pro iFrame" style="border: 1px solid #EEEEEE;" />';
...
$_['client_secret']                    = 'client-secret required!';